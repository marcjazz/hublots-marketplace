    ...
    <div className="p-3">
      ...
      >
        <div className="flex size-7 items-center justify-center">
          {fallback ? (
            <ImageAvatar src={avatar || "https://avatars.githubusercontent.com/u/157491783?s=400&u=fa9190c57626f1a13368c3561cf4ce8ddaaa778a&v=4"} size={7} rounded />
          ) : (
...
const UserItem = () => {
  ...
  return (
    <div className="flex items-center gap-x-3 overflow-hidden px-2 py-1">
      <div className="w-10">
        <ImageAvatar src={avatar || "https://avatars.githubusercontent.com/u/157491783?s=400&u=fa9190c57626f1a13368c3561cf4ce8ddaaa778a&v=4"} size={8} rounded />
      </div>
